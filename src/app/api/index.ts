...
export type SystemMessageDataFragment =
...
export type ListenOnSystemSubscription = {
    __typename?: 'Subscription';
    message:
        | { __typename: 'MessageNotice'; date: string | Date; message: string }
        | { __typename: 'UserSessionRevoked'; date: string | Date; displayNotice: boolean };
};

export type UserPreviewDataFragment = { __typename?: 'User'; id: string; displayName: string };

export type UserListDataFragment = {
    __typename?: 'User';
    id: string;
    displayName: string;
    email: string;
...
export type UserFullDataFragment = {
    __typename?: 'User';
    id: string;
    username: string;
    displayName: string;
...
export type GetAuthenticatedUserSessionsQuery = {
    __typename?: 'Query';
    currentUser?: {
        __typename?: 'User';
        id: string;
...
export type GetAuthenticatedUserWebAuthnKeysQuery = {
    __typename?: 'Query';
    currentUser?: {
        __typename?: 'User';
        id: string;
...
export type AuthenticateMutation = {
    __typename?: 'Mutation';
    authenticate:
        | { __typename: 'AuthenticationRequiresNewPassword'; token: string }
        | { __typename: 'AuthenticationRequiresTOTP'; token: string }
        | {
              __typename: 'AuthenticationSuccessful';
              token: string;
              user: {
...
export type AuthenticateWithWebAuthnMutation = {
    __typename?: 'Mutation';
    authenticate:
        | { __typename: 'AuthenticationRequiresNewPassword' }
        | { __typename: 'AuthenticationRequiresTOTP' }
...
export type ChangePasswordFromAuthenticationMutation = {
    __typename?: 'Mutation';
    changePasswordFromAuthentication:
        | { __typename: 'AuthenticationRequiresNewPassword' }
        | { __typename: 'AuthenticationRequiresTOTP' }
        | {
              __typename: 'AuthenticationSuccessful';
...
export type GenerateAuthenticatorSetupQuery = {
    __typename?: 'Query';
    response: { __typename?: 'AuthenticatorSetup'; secret: string; qrcodeUri: string };
};
...
export type GenerateAuthenticatorChallengeQuery = {
    __typename?: 'Query';
    generateAuthenticatorChallenge?: {
        __typename?: 'AuthenticationWithWebPublicKeyCredential';
        token: string;
        challenge: string;
...
export type RevokeWebPublicKeyCredentialMutation = {
    __typename?: 'Mutation';
    revokeWebPublicKeyCredential?: string | null;
};

export type RequestWebPublicKeyCredentialRegistrationMutationVariables = Exact<{ [key: string]: never }>;

export type RequestWebPublicKeyCredentialRegistrationMutation = {
    __typename?: 'Mutation';
    requestWebPublicKeyCredentialRegistration: {
        __typename?: 'WebPublicKeyCredentialRegistrationRequest';
        token: string;
        options: any;
    };
...
export type CompleteWebPublicKeyCredentialRegistrationMutation = {
    __typename?: 'Mutation';
...
export const SystemMessageDataFragmentDoc = /* #__PURE__ */ {
    ...
    definitions: [
        {
            kind: 'FragmentDefinition',
            name: { kind: 'Name', value: 'SystemMessageData' },
            typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'SystemMessage' } },
            selectionSet: {
                kind: 'SelectionSet',
                selections: [
                    ...
                    {
                        kind: 'InlineFragment',
                        typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'UserSessionRevoked' } },
                        selectionSet: {
                            kind: 'SelectionSet',
                            selections: [
                                { kind: 'Field', name: { kind: 'Name', value: 'date' } },
                                { kind: 'Field', name: { kind: 'Name', value: 'displayNotice' } },
                            ],
                        },
                    },
                    {
                        kind: 'InlineFragment',
                        typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'MessageNotice' } },
                        selectionSet: {
                            kind: 'SelectionSet',
                            selections: [
                                { kind: 'Field', name: { kind: 'Name', value: 'date' } },
...
export const UserListDataFragmentDoc = /* #__PURE__ */ {
    kind: 'Document',
    definitions: [
        {
            kind: 'FragmentDefinition',
            name: { kind: 'Name', value: 'UserListData' },
            typeCondition: { kind: 'NamedType', name: { kind: 'Name', value: 'User' } },
            selectionSet: {
                kind: 'SelectionSet',
                selections: [
...
export const CurrentUserDataFragmentDoc = /* #__PURE__ */ {
    kind: 'Document',
    definitions: [
        {
            kind: 'FragmentDefinition',
...
export const RetrieveLinkDocument = /* #__PURE__ */ {
    kind: 'Document',
    definitions: [
        {
            kind: 'OperationDefinition',
            operation: 'query',
            name: { kind: 'Name', value: 'retrieveLink' },
            variableDefinitions: [
                {
                        ...
                        selectionSet: {
                            ...
                            selections: [
                                { kind: 'Field', name: { kind: 'Name', value: '__typename' } },
                                {
                                    ...
                                    typeCondition: {
                                        kind: 'NamedType',
                                        name: { kind: 'Name', value: 'ResetPasswordLink' },
                                    },
                                    selectionSet: {
                                        kind: 'SelectionSet',
 ...
 * });
 */
export function useRetrieveLinkQuery(
    baseOptions: Apollo.QueryHookOptions<RetrieveLinkQuery, RetrieveLinkQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };

    return Apollo.useQuery<RetrieveLinkQuery, RetrieveLinkQueryVariables>(RetrieveLinkDocument, options);
}
export function useRetrieveLinkLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<RetrieveLinkQuery, RetrieveLinkQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };
    ...
    definitions: [
        {
            ...
            name: { kind: 'Name', value: 'listenOnSystem' },
            selectionSet: {
                kind: 'SelectionSet',
                selections: [
                    {
                        ...
                        name: { kind: 'Name', value: 'listenSystemMessages' },
                        selectionSet: {
                            kind: 'SelectionSet',
                            selections: [
                                { kind: 'FragmentSpread', name: { kind: 'Name', value: 'SystemMessageData' } },
                            ],
                        },
                    },
                ],
 ...
 * });
 */
export function useListenOnSystemSubscription(
    baseOptions?: Apollo.SubscriptionHookOptions<ListenOnSystemSubscription, ListenOnSystemSubscriptionVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };

    return Apollo.useSubscription<ListenOnSystemSubscription, ListenOnSystemSubscriptionVariables>(
...
export const GetAuthenticatedUserDocument = /* #__PURE__ */ {
    kind: 'Document',
    definitions: [
        {
            kind: 'OperationDefinition',
...
export function useGetAuthenticatedUserQuery(
    baseOptions?: Apollo.QueryHookOptions<GetAuthenticatedUserQuery, GetAuthenticatedUserQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };

    return Apollo.useQuery<GetAuthenticatedUserQuery, GetAuthenticatedUserQueryVariables>(
        GetAuthenticatedUserDocument,
        options
    );
}
export function useGetAuthenticatedUserLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<GetAuthenticatedUserQuery, GetAuthenticatedUserQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };

    return Apollo.useLazyQuery<GetAuthenticatedUserQuery, GetAuthenticatedUserQueryVariables>(
        GetAuthenticatedUserDocument,
        options
    );
}
...
>;
export const GetAuthenticatedUserSessionsDocument = /* #__PURE__ */ {
    kind: 'Document',
    definitions: [
        {
            kind: 'OperationDefinition',
            operation: 'query',
            name: { kind: 'Name', value: 'getAuthenticatedUserSessions' },
            selectionSet: {
                kind: 'SelectionSet',
                selections: [
                    {
 ...
 * });
 */
export function useGetAuthenticatedUserSessionsQuery(
    baseOptions?: Apollo.QueryHookOptions<GetAuthenticatedUserSessionsQuery, GetAuthenticatedUserSessionsQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };

    return Apollo.useQuery<GetAuthenticatedUserSessionsQuery, GetAuthenticatedUserSessionsQueryVariables>(
        GetAuthenticatedUserSessionsDocument,
        options
    );
}
export function useGetAuthenticatedUserSessionsLazyQuery(
    ...
    return Apollo.useLazyQuery<GetAuthenticatedUserSessionsQuery, GetAuthenticatedUserSessionsQueryVariables>(
        GetAuthenticatedUserSessionsDocument,
        options
    );
}
export type GetAuthenticatedUserSessionsQueryHookResult = ReturnType<typeof useGetAuthenticatedUserSessionsQuery>;
export type GetAuthenticatedUserSessionsLazyQueryHookResult = ReturnType<
    typeof useGetAuthenticatedUserSessionsLazyQuery
>;
export type GetAuthenticatedUserSessionsQueryResult = Apollo.QueryResult<
    GetAuthenticatedUserSessionsQuery,
    GetAuthenticatedUserSessionsQueryVariables
>;
export const GetAuthenticatedUserWebAuthnKeysDocument = /* #__PURE__ */ {
    kind: 'Document',
    definitions: [
        {
            kind: 'OperationDefinition',
                ...
                selections: [
                    {
                        ...
                        selectionSet: {
                            ...
                            selections: [
                                ...
                                {
                                    kind: 'Field',
                                    name: { kind: 'Name', value: 'webAuthnKeys' },
                                    selectionSet: {
                                        kind: 'SelectionSet',
                                        selections: [
                                            { kind: 'Field', name: { kind: 'Name', value: 'id' } },
                                            ...
                                            { kind: 'Field', name: { kind: 'Name', value: 'rawKeyId' } },
                                        ],
                                    },
                                },
                            ],
 ...
 * });
 */
export function useGetAuthenticatedUserWebAuthnKeysQuery(
    ...
    return Apollo.useQuery<GetAuthenticatedUserWebAuthnKeysQuery, GetAuthenticatedUserWebAuthnKeysQueryVariables>(
        GetAuthenticatedUserWebAuthnKeysDocument,
        options
    );
}
export function useGetAuthenticatedUserWebAuthnKeysLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<
        GetAuthenticatedUserWebAuthnKeysQuery,
        GetAuthenticatedUserWebAuthnKeysQueryVariables
    >
    ...
    return Apollo.useLazyQuery<GetAuthenticatedUserWebAuthnKeysQuery, GetAuthenticatedUserWebAuthnKeysQueryVariables>(
        GetAuthenticatedUserWebAuthnKeysDocument,
        options
    );
}
export type GetAuthenticatedUserWebAuthnKeysQueryHookResult = ReturnType<
    typeof useGetAuthenticatedUserWebAuthnKeysQuery
>;
export type GetAuthenticatedUserWebAuthnKeysLazyQueryHookResult = ReturnType<
    typeof useGetAuthenticatedUserWebAuthnKeysLazyQuery
>;
export type GetAuthenticatedUserWebAuthnKeysQueryResult = Apollo.QueryResult<
    GetAuthenticatedUserWebAuthnKeysQuery,
    GetAuthenticatedUserWebAuthnKeysQueryVariables
>;
export const RevokeSessionDocument = /* #__PURE__ */ {
    kind: 'Document',
    definitions: [
        {
            kind: 'OperationDefinition',
            ...
            variableDefinitions: [
                ...
                {
                    kind: 'VariableDefinition',
                    variable: { kind: 'Variable', name: { kind: 'Name', value: 'displayNotice' } },
                ...
                selections: [
                    {
                        ...
                        arguments: [
                            ...
                            {
                                kind: 'Argument',
                                name: { kind: 'Name', value: 'displayNotice' },
                                value: { kind: 'Variable', name: { kind: 'Name', value: 'displayNotice' } },
                            },
                        ],
                    },
                ],
                        ...
                        selectionSet: {
                            ...
                            selections: [
                                { kind: 'Field', name: { kind: 'Name', value: '__typename' } },
                                {
                                    ...
                                    typeCondition: {
                                        kind: 'NamedType',
                                        name: { kind: 'Name', value: 'AuthenticationSuccessful' },
                                    },
                                    selectionSet: {
                                        kind: 'SelectionSet',
                                        selections: [
                                ...
                                },
                                {
                                    ...
                                    typeCondition: {
                                        kind: 'NamedType',
                                        name: { kind: 'Name', value: 'AuthenticationRequiresNewPassword' },
                                    },
                                    selectionSet: {
                                        kind: 'SelectionSet',
                                        selections: [{ kind: 'Field', name: { kind: 'Name', value: 'token' } }],
                                ...
                                },
                                {
                                    ...
                                    typeCondition: {
                                        kind: 'NamedType',
                                        name: { kind: 'Name', value: 'AuthenticationRequiresTOTP' },
                                    },
                                    selectionSet: {
                                        kind: 'SelectionSet',
                                        selections: [{ kind: 'Field', name: { kind: 'Name', value: 'token' } }],
...
>;
export const AuthenticateWithWebAuthnDocument = /* #__PURE__ */ {
    kind: 'Document',
    definitions: [
        {
            kind: 'OperationDefinition',
            operation: 'mutation',
            name: { kind: 'Name', value: 'authenticateWithWebAuthn' },
            variableDefinitions: [
                {
                    kind: 'VariableDefinition',
            ...
            selectionSet: {
                ...
                selections: [
                    {
                        kind: 'Field',
                        alias: { kind: 'Name', value: 'authenticate' },
                        name: { kind: 'Name', value: 'authenticateWithWebPublicKeyCredential' },
                        arguments: [
                            {
                                kind: 'Argument',
...
export type AuthenticateWithWebAuthnMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useAuthenticateWithWebAuthnMutation(
    ...
    return Apollo.useMutation<AuthenticateWithWebAuthnMutation, AuthenticateWithWebAuthnMutationVariables>(
...
export type AuthenticateWithWebAuthnMutationOptions = Apollo.BaseMutationOptions<
    AuthenticateWithWebAuthnMutation,
    AuthenticateWithWebAuthnMutationVariables
>;
export const ChangePasswordFromAuthenticationDocument = /* #__PURE__ */ {
    kind: 'Document',
    definitions: [
        {
            kind: 'OperationDefinition',
            operation: 'mutation',
            name: { kind: 'Name', value: 'changePasswordFromAuthentication' },
            variableDefinitions: [
                {
                    kind: 'VariableDefinition',
                    variable: { kind: 'Variable', name: { kind: 'Name', value: 'token' } },
...
export type ChangePasswordFromAuthenticationMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useChangePasswordFromAuthenticationMutation(
    baseOptions?: Apollo.MutationHookOptions<
        ChangePasswordFromAuthenticationMutation,
        ChangePasswordFromAuthenticationMutationVariables
    >
    ...
    return Apollo.useMutation<
        ChangePasswordFromAuthenticationMutation,
        ChangePasswordFromAuthenticationMutationVariables
    >(ChangePasswordFromAuthenticationDocument, options);
}
export type ChangePasswordFromAuthenticationMutationHookResult = ReturnType<
    typeof useChangePasswordFromAuthenticationMutation
>;
export type ChangePasswordFromAuthenticationMutationResult =
    Apollo.MutationResult<ChangePasswordFromAuthenticationMutation>;
export type ChangePasswordFromAuthenticationMutationOptions = Apollo.BaseMutationOptions<
    ChangePasswordFromAuthenticationMutation,
    ChangePasswordFromAuthenticationMutationVariables
>;
export const AuthenticateWithTotpDocument = /* #__PURE__ */ {
    kind: 'Document',
    definitions: [
        {
            kind: 'OperationDefinition',
            operation: 'mutation',
            name: { kind: 'Name', value: 'authenticateWithTOTP' },
            variableDefinitions: [
                {
                    kind: 'VariableDefinition',
                    variable: { kind: 'Variable', name: { kind: 'Name', value: 'token' } },
...
export type AuthenticateWithTotpMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useAuthenticateWithTotpMutation(
    baseOptions?: Apollo.MutationHookOptions<AuthenticateWithTotpMutation, AuthenticateWithTotpMutationVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };

    return Apollo.useMutation<AuthenticateWithTotpMutation, AuthenticateWithTotpMutationVariables>(
...
export type AuthenticateWithTotpMutationOptions = Apollo.BaseMutationOptions<
    AuthenticateWithTotpMutation,
    AuthenticateWithTotpMutationVariables
>;
...
export type RefreshCredentialsMutationOptions = Apollo.BaseMutationOptions<
    ...
    RefreshCredentialsMutationVariables
>;
export const ApplyForPasswordChangeDocument = /* #__PURE__ */ {
    kind: 'Document',
    definitions: [
        {
            kind: 'OperationDefinition',
            operation: 'mutation',
            name: { kind: 'Name', value: 'applyForPasswordChange' },
            variableDefinitions: [
                {
                    kind: 'VariableDefinition',
                    variable: { kind: 'Variable', name: { kind: 'Name', value: 'username' } },
...
export type ApplyForPasswordChangeMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useApplyForPasswordChangeMutation(
    baseOptions?: Apollo.MutationHookOptions<ApplyForPasswordChangeMutation, ApplyForPasswordChangeMutationVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };

    return Apollo.useMutation<ApplyForPasswordChangeMutation, ApplyForPasswordChangeMutationVariables>(
...
export type ApplyForPasswordChangeMutationOptions = Apollo.BaseMutationOptions<
    ApplyForPasswordChangeMutation,
    ApplyForPasswordChangeMutationVariables
>;
export const ChangePasswordFromTokenDocument = /* #__PURE__ */ {
    kind: 'Document',
    definitions: [
        {
            kind: 'OperationDefinition',
            operation: 'mutation',
            name: { kind: 'Name', value: 'changePasswordFromToken' },
            variableDefinitions: [
                {
                    kind: 'VariableDefinition',
                    variable: { kind: 'Variable', name: { kind: 'Name', value: 'token' } },
...
export function useChangePasswordFromTokenMutation(
    baseOptions?: Apollo.MutationHookOptions<ChangePasswordFromTokenMutation, ChangePasswordFromTokenMutationVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };

    return Apollo.useMutation<ChangePasswordFromTokenMutation, ChangePasswordFromTokenMutationVariables>(
    ...
    definitions: [
        {
            ...
            variableDefinitions: [
                ...
                },
                {
                    ...
                    type: { kind: 'NamedType', name: { kind: 'Name', value: 'UserSortingRule' } },
                },
            ],
            selectionSet: {
                kind: 'SelectionSet',
                            ...
                            selections: [
                                { kind: 'Field', name: { kind: 'Name', value: 'count' } },
                                {
                                    ...
                                    selectionSet: {
                                        kind: 'SelectionSet',
                                        selections: [
                                            { kind: 'FragmentSpread', name: { kind: 'Name', value: 'UserListData' } },
                                        ],
                                    },
                                },
                            ],
...
export const GenerateAuthenticatorSetupDocument = /* #__PURE__ */ {
    kind: 'Document',
    definitions: [
        {
            kind: 'OperationDefinition',
            operation: 'query',
            name: { kind: 'Name', value: 'generateAuthenticatorSetup' },
            selectionSet: {
                kind: 'SelectionSet',
                selections: [
                    {
                        ...
                        selectionSet: {
                            ...
                            selections: [
                                ...
                                { kind: 'Field', name: { kind: 'Name', value: 'qrcodeUri' } },
                            ],
                        },
                    },
                ],
 ...
 * });
 */
export function useGenerateAuthenticatorSetupQuery(
    baseOptions?: Apollo.QueryHookOptions<GenerateAuthenticatorSetupQuery, GenerateAuthenticatorSetupQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };

    return Apollo.useQuery<GenerateAuthenticatorSetupQuery, GenerateAuthenticatorSetupQueryVariables>(
        GenerateAuthenticatorSetupDocument,
        options
    );
}
export function useGenerateAuthenticatorSetupLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<GenerateAuthenticatorSetupQuery, GenerateAuthenticatorSetupQueryVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };

    return Apollo.useLazyQuery<GenerateAuthenticatorSetupQuery, GenerateAuthenticatorSetupQueryVariables>(
        GenerateAuthenticatorSetupDocument,
        options
    );
}
...
export type GenerateAuthenticatorSetupQueryResult = Apollo.QueryResult<
    GenerateAuthenticatorSetupQuery,
    GenerateAuthenticatorSetupQueryVariables
>;
export const EnableAuthenticatorDocument = /* #__PURE__ */ {
    kind: 'Document',
    definitions: [
        {
            kind: 'OperationDefinition',
            operation: 'mutation',
            name: { kind: 'Name', value: 'enableAuthenticator' },
            variableDefinitions: [
                {
                    kind: 'VariableDefinition',
...
export type EnableAuthenticatorMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useEnableAuthenticatorMutation(
    baseOptions?: Apollo.MutationHookOptions<EnableAuthenticatorMutation, EnableAuthenticatorMutationVariables>
) {
    const options = { ...defaultOptions, ...baseOptions };

    return Apollo.useMutation<EnableAuthenticatorMutation, EnableAuthenticatorMutationVariables>(
                ...
                selections: [
                    {
                        ...
                        selectionSet: {
                            ...
                            selections: [
                                ...
                                { kind: 'Field', name: { kind: 'Name', value: 'allowCredentials' } },
 ...
 * });
 */
export function useGenerateAuthenticatorChallengeQuery(
    baseOptions: Apollo.QueryHookOptions<
    ...
    return Apollo.useQuery<GenerateAuthenticatorChallengeQuery, GenerateAuthenticatorChallengeQueryVariables>(
        GenerateAuthenticatorChallengeDocument,
        options
    );
}
export function useGenerateAuthenticatorChallengeLazyQuery(
    baseOptions?: Apollo.LazyQueryHookOptions<
        GenerateAuthenticatorChallengeQuery,
        GenerateAuthenticatorChallengeQueryVariables
    >
    ...
    return Apollo.useLazyQuery<GenerateAuthenticatorChallengeQuery, GenerateAuthenticatorChallengeQueryVariables>(
        GenerateAuthenticatorChallengeDocument,
        options
    );
}
export type GenerateAuthenticatorChallengeQueryHookResult = ReturnType<typeof useGenerateAuthenticatorChallengeQuery>;
export type GenerateAuthenticatorChallengeLazyQueryHookResult = ReturnType<
    typeof useGenerateAuthenticatorChallengeLazyQuery
>;
export type GenerateAuthenticatorChallengeQueryResult = Apollo.QueryResult<
    GenerateAuthenticatorChallengeQuery,
    GenerateAuthenticatorChallengeQueryVariables
>;
export const RevokeWebPublicKeyCredentialDocument = /* #__PURE__ */ {
    kind: 'Document',
    definitions: [
        {
            kind: 'OperationDefinition',
            operation: 'mutation',
            name: { kind: 'Name', value: 'revokeWebPublicKeyCredential' },
            variableDefinitions: [
                {
                    kind: 'VariableDefinition',
                    variable: { kind: 'Variable', name: { kind: 'Name', value: 'keyId' } },
                    type: {
                        kind: 'NonNullType',
                        type: { kind: 'NamedType', name: { kind: 'Name', value: 'ObjectID' } },
                    },
                        ...
                        arguments: [
                            {
                                kind: 'Argument',
                                name: { kind: 'Name', value: 'id' },
                                value: { kind: 'Variable', name: { kind: 'Name', value: 'keyId' } },
                            },
                        ],
                    },
                ],
...
export type RevokeWebPublicKeyCredentialMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useRevokeWebPublicKeyCredentialMutation(
    baseOptions?: Apollo.MutationHookOptions<
        RevokeWebPublicKeyCredentialMutation,
        RevokeWebPublicKeyCredentialMutationVariables
    >
    ...
    return Apollo.useMutation<RevokeWebPublicKeyCredentialMutation, RevokeWebPublicKeyCredentialMutationVariables>(
...
export type RevokeWebPublicKeyCredentialMutationOptions = Apollo.BaseMutationOptions<
    RevokeWebPublicKeyCredentialMutation,
    RevokeWebPublicKeyCredentialMutationVariables
>;
export const RequestWebPublicKeyCredentialRegistrationDocument = /* #__PURE__ */ {
    kind: 'Document',
    definitions: [
        {
            kind: 'OperationDefinition',
...
export type RequestWebPublicKeyCredentialRegistrationMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useRequestWebPublicKeyCredentialRegistrationMutation(
    baseOptions?: Apollo.MutationHookOptions<
        RequestWebPublicKeyCredentialRegistrationMutation,
        RequestWebPublicKeyCredentialRegistrationMutationVariables
    >
    ...
    return Apollo.useMutation<
        RequestWebPublicKeyCredentialRegistrationMutation,
        RequestWebPublicKeyCredentialRegistrationMutationVariables
    >(RequestWebPublicKeyCredentialRegistrationDocument, options);
}
export type RequestWebPublicKeyCredentialRegistrationMutationHookResult = ReturnType<
    typeof useRequestWebPublicKeyCredentialRegistrationMutation
>;
export type RequestWebPublicKeyCredentialRegistrationMutationResult =
    Apollo.MutationResult<RequestWebPublicKeyCredentialRegistrationMutation>;
export type RequestWebPublicKeyCredentialRegistrationMutationOptions = Apollo.BaseMutationOptions<
    RequestWebPublicKeyCredentialRegistrationMutation,
    RequestWebPublicKeyCredentialRegistrationMutationVariables
>;
export const CompleteWebPublicKeyCredentialRegistrationDocument = /* #__PURE__ */ {
    kind: 'Document',
    definitions: [
        {
            kind: 'OperationDefinition',
...
export type CompleteWebPublicKeyCredentialRegistrationMutationFn = Apollo.MutationFunction<
 ...
 * });
 */
export function useCompleteWebPublicKeyCredentialRegistrationMutation(
    baseOptions?: Apollo.MutationHookOptions<
        CompleteWebPublicKeyCredentialRegistrationMutation,
        CompleteWebPublicKeyCredentialRegistrationMutationVariables
    >
    ...
    return Apollo.useMutation<
        CompleteWebPublicKeyCredentialRegistrationMutation,
        CompleteWebPublicKeyCredentialRegistrationMutationVariables
    >(CompleteWebPublicKeyCredentialRegistrationDocument, options);
}
export type CompleteWebPublicKeyCredentialRegistrationMutationHookResult = ReturnType<
    typeof useCompleteWebPublicKeyCredentialRegistrationMutation
>;
export type CompleteWebPublicKeyCredentialRegistrationMutationResult =
    Apollo.MutationResult<CompleteWebPublicKeyCredentialRegistrationMutation>;
export type CompleteWebPublicKeyCredentialRegistrationMutationOptions = Apollo.BaseMutationOptions<
    CompleteWebPublicKeyCredentialRegistrationMutation,
    CompleteWebPublicKeyCredentialRegistrationMutationVariables
>;
