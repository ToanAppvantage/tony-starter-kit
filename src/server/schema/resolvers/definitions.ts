...
export type GraphQLAuthenticationResponse =
    | GraphQLAuthenticationRequiresNewPassword
    | GraphQLAuthenticationRequiresTotp
    | GraphQLAuthenticationSuccessful;
...
export type GraphQLResolversTypes = {
    AuthenticationRequiresNewPassword: ResolverTypeWrapper<
        Omit<GraphQLAuthenticationRequiresNewPassword, 'user'> & { user: GraphQLResolversTypes['User'] }
    >;
    ...
    PaginatedUsers: ResolverTypeWrapper<
        Omit<GraphQLPaginatedUsers, 'items'> & { items: Array<GraphQLResolversTypes['User']> }
    >;
    Pagination: GraphQLPagination;
...
export type GraphQLResolversParentTypes = {
    AuthenticationRequiresNewPassword: Omit<GraphQLAuthenticationRequiresNewPassword, 'user'> & {
...
export type GraphQLAuthenticationRequiresNewPasswordResolvers<
    ContextType = Context,
    ParentType extends GraphQLResolversParentTypes['AuthenticationRequiresNewPassword'] = GraphQLResolversParentTypes['AuthenticationRequiresNewPassword']
> = {
...
export type GraphQLAuthenticationRequiresTotpResolvers<
    ContextType = Context,
    ParentType extends GraphQLResolversParentTypes['AuthenticationRequiresTOTP'] = GraphQLResolversParentTypes['AuthenticationRequiresTOTP']
> = {
    token?: Resolver<GraphQLResolversTypes['String'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type GraphQLAuthenticationResponseResolvers<
    ContextType = Context,
    ParentType extends GraphQLResolversParentTypes['AuthenticationResponse'] = GraphQLResolversParentTypes['AuthenticationResponse']
> = {
    __resolveType: TypeResolveFn<
        'AuthenticationRequiresNewPassword' | 'AuthenticationRequiresTOTP' | 'AuthenticationSuccessful',
        ParentType,
        ContextType
    >;
};
...
export type GraphQLAuthenticationWithWebPublicKeyCredentialResolvers<
    ContextType = Context,
    ParentType extends GraphQLResolversParentTypes['AuthenticationWithWebPublicKeyCredential'] = GraphQLResolversParentTypes['AuthenticationWithWebPublicKeyCredential']
> = {
...
export type GraphQLAuthenticatorSetupResolvers<
    ContextType = Context,
    ParentType extends GraphQLResolversParentTypes['AuthenticatorSetup'] = GraphQLResolversParentTypes['AuthenticatorSetup']
> = {
...
export type GraphQLExternalLinkResolvers<
    ContextType = Context,
    ParentType extends GraphQLResolversParentTypes['ExternalLink'] = GraphQLResolversParentTypes['ExternalLink']
> = {
    __resolveType: TypeResolveFn<'ResetPasswordLink', ParentType, ContextType>;
};

export interface GraphQLJsonObjectScalarConfig
    extends GraphQLScalarTypeConfig<GraphQLResolversTypes['JSONObject'], any> {
    name: 'JSONObject';
}
...
> = {
    applyForPasswordChange?: Resolver<
        GraphQLResolversTypes['Boolean'],
        ParentType,
        ContextType,
        RequireFields<GraphQLMutationApplyForPasswordChangeArgs, 'username'>
    >;
    authenticate?: Resolver<
        GraphQLResolversTypes['AuthenticationResponse'],
        ParentType,
        ContextType,
        RequireFields<GraphQLMutationAuthenticateArgs, 'password' | 'username'>
    >;
    authenticateWithTOTP?: Resolver<
        GraphQLResolversTypes['AuthenticationResponse'],
        ParentType,
        ContextType,
        RequireFields<GraphQLMutationAuthenticateWithTotpArgs, 'password' | 'token'>
    >;
    authenticateWithWebPublicKeyCredential?: Resolver<
        GraphQLResolversTypes['AuthenticationResponse'],
        ParentType,
        ContextType,
        RequireFields<GraphQLMutationAuthenticateWithWebPublicKeyCredentialArgs, 'response' | 'token'>
    >;
    changePasswordFromAuthentication?: Resolver<
        GraphQLResolversTypes['AuthenticationResponse'],
        ParentType,
        ContextType,
        RequireFields<GraphQLMutationChangePasswordFromAuthenticationArgs, 'password' | 'token'>
    >;
    changePasswordFromToken?: Resolver<
        GraphQLResolversTypes['Boolean'],
        ParentType,
        ContextType,
        RequireFields<GraphQLMutationChangePasswordFromTokenArgs, 'token'>
    >;
    completeWebPublicKeyCredentialRegistration?: Resolver<
        GraphQLResolversTypes['Boolean'],
        ParentType,
        ContextType,
        RequireFields<GraphQLMutationCompleteWebPublicKeyCredentialRegistrationArgs, 'response' | 'token'>
    >;
    ...
    enableAuthenticator?: Resolver<
        ...
        ParentType,
        ContextType,
        RequireFields<GraphQLMutationEnableAuthenticatorArgs, 'secret' | 'token'>
    >;
    generateWebCredentialAuthentication?: Resolver<
        Maybe<GraphQLResolversTypes['AuthenticationWithWebPublicKeyCredential']>,
        ParentType,
        ContextType,
        RequireFields<GraphQLMutationGenerateWebCredentialAuthenticationArgs, 'username'>
    >;
    refreshCredentials?: Resolver<GraphQLResolversTypes['String'], ParentType, ContextType>;
    requestWebPublicKeyCredentialRegistration?: Resolver<
        GraphQLResolversTypes['WebPublicKeyCredentialRegistrationRequest'],
        ParentType,
        ContextType
    >;
    revokeUserSession?: Resolver<
        ...
        ParentType,
        ContextType,
        RequireFields<GraphQLMutationRevokeUserSessionArgs, 'id'>
    >;
    revokeWebPublicKeyCredential?: Resolver<
        Maybe<GraphQLResolversTypes['String']>,
        ParentType,
        ContextType,
        RequireFields<GraphQLMutationRevokeWebPublicKeyCredentialArgs, 'id'>
    >;
...
export type GraphQLPaginatedUsersResolvers<
    ContextType = Context,
    ParentType extends GraphQLResolversParentTypes['PaginatedUsers'] = GraphQLResolversParentTypes['PaginatedUsers']
> = {
...
> = {
    ...
    generateAuthenticatorChallenge?: Resolver<
        Maybe<GraphQLResolversTypes['AuthenticationWithWebPublicKeyCredential']>,
        ParentType,
        ContextType,
    ...
    listUsers?: Resolver<
        ...
        ParentType,
        ContextType,
        RequireFields<GraphQLQueryListUsersArgs, 'pagination'>
    >;
    retrieveLink?: Resolver<
        Maybe<GraphQLResolversTypes['ExternalLink']>,
        ParentType,
        ContextType,
        RequireFields<GraphQLQueryRetrieveLinkArgs, 'id'>
    >;
};

export type GraphQLResetPasswordLinkResolvers<
    ContextType = Context,
    ParentType extends GraphQLResolversParentTypes['ResetPasswordLink'] = GraphQLResolversParentTypes['ResetPasswordLink']
> = {
    token?: Resolver<GraphQLResolversTypes['String'], ParentType, ContextType>;
    __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
> = {
    listenSystemMessages?: SubscriptionResolver<
        GraphQLResolversTypes['SystemMessage'],
...
export type GraphQLSystemMessageResolvers<
    ContextType = Context,
    ParentType extends GraphQLResolversParentTypes['SystemMessage'] = GraphQLResolversParentTypes['SystemMessage']
> = {
...
export type GraphQLUserSessionResolvers<
    ContextType = Context,
    ParentType extends GraphQLResolversParentTypes['UserSession'] = GraphQLResolversParentTypes['UserSession']
> = {
...
export type GraphQLUserSessionRevokedResolvers<
    ContextType = Context,
    ParentType extends GraphQLResolversParentTypes['UserSessionRevoked'] = GraphQLResolversParentTypes['UserSessionRevoked']
> = {
    date?: Resolver<GraphQLResolversTypes['DateTime'], ParentType, ContextType>;
...
export type GraphQLUserSortingFieldResolvers = EnumResolverSignature<
    { Authenticator?: any; Email?: any },
    GraphQLResolversTypes['UserSortingField']
>;

export type GraphQLUserWebAuthnKeyResolvers<
    ContextType = Context,
    ParentType extends GraphQLResolversParentTypes['UserWebAuthnKey'] = GraphQLResolversParentTypes['UserWebAuthnKey']
> = {
    expiresAt?: Resolver<GraphQLResolversTypes['DateTime'], ParentType, ContextType>;
    id?: Resolver<GraphQLResolversTypes['ObjectID'], ParentType, ContextType>;
...
export type GraphQLWebPublicKeyCredentialRegistrationRequestResolvers<
    ContextType = Context,
    ParentType extends GraphQLResolversParentTypes['WebPublicKeyCredentialRegistrationRequest'] = GraphQLResolversParentTypes['WebPublicKeyCredentialRegistrationRequest']
> = {
